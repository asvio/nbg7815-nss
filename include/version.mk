...
VERSION_NUMBER:=$(if $(VERSION_NUMBER),$(VERSION_NUMBER),NBG7815-24.10.0-rc1-NSS)

VERSION_CODE:=$(call qstrip,$(CONFIG_VERSION_CODE))
VERSION_CODE:=$(if $(VERSION_CODE),$(VERSION_CODE),r28158+168-d276b4c91a-97c2db1fa8fa)

VERSION_REPO:=$(call qstrip,$(CONFIG_VERSION_REPO))
VERSION_REPO:=$(if $(VERSION_REPO),$(VERSION_REPO),https://github.com/asvio/nbg7815-nss/releases/tag/24.10.0-rc1-nss)
